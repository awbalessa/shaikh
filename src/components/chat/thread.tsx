    ...
    <AnimatePresence>
      {showButton && (
        <motion.button
          ...
          onClick={onClick}
          className={cn(
            "absolute z-50 bottom-2 left-1/2 -translate-x-1/2 bg-background dark:bg-surface-raised border border-border focus-visible:border-transparent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-full p-1.5",
            className,
          )}
          {...props}
        >
