...
SYSTEM_INSTRUCTION = """You are an Arabic linguistics expert specializing in reviewing and correcting OCR (Optical Character Recognition) results from classical Arabic books.
    ...
    Important Note: Never output anything aside from the output text you are expected to return. No annotations, comments, or any other output. Stick strictly to the page contents.
    """
...
assert GEMINI_LITE is not None, "Gemini is missing"
